...
namespace DNXTest.Controllers
{
    public class ContactPhonesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind("Id,CountryCode,Number,Description")] ContactPhone contactPhone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind("Id,CountryCode,Number,Description")] ContactPhone contactPhone)
        {
            if (ModelState.IsValid)
            {
