...
namespace DNXTest.Migrations
{
    ...
    partial class init
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DNXTest.Models.ContactDonorInfo", b =>
                {
                    ...
                    b.Property<int?>("DonorReligiousSituationId");
            ...
            modelBuilder.Entity("DNXTest.Models.ContactHealthInfo", b =>
                {
                    ...
                    b.Property<int?>("ContactBloodTypeId");
            ...
            modelBuilder.Entity("DNXTest.Models.ContactIdentification", b =>
                {
                    ...
                    b.Property<int?>("BornInCountryId");
            ...
            modelBuilder.Entity("DNXTest.Models.DonorContext", b =>
                {
                    ...
                    b.Property<Guid?>("ContactDonorInfoId");
            ...
            modelBuilder.Entity("DNXTest.Models.SpokenLanguage", b =>
                {
                    ...
                    b.Property<Guid?>("ContactIdentificationId");
            ...
            modelBuilder.Entity("DNXTest.Models.ContactAddress", b =>
                {
                    ...
                    b.HasOne("DNXTest.Models.Country")
                        .WithMany()
            ...
            modelBuilder.Entity("DNXTest.Models.ContactDonorInfo", b =>
                {
                    b.HasOne("DNXTest.Models.DonorReligiousSituation")
                        .WithMany()
                        .HasForeignKey("DonorReligiousSituationId");

                    b.HasOne("DNXTest.Models.DonorType")
                        .WithMany()
            ...
            modelBuilder.Entity("DNXTest.Models.ContactHealthInfo", b =>
                {
                    b.HasOne("DNXTest.Models.ContactBloodType")
                        .WithMany()
                        .HasForeignKey("ContactBloodTypeId");
            ...
            modelBuilder.Entity("DNXTest.Models.ContactIdentification", b =>
                {
                    b.HasOne("DNXTest.Models.Country")
                        .WithMany()
                        .HasForeignKey("BornInCountryId");

                    b.HasOne("DNXTest.Models.Contact")
                        .WithOne()
                        .HasForeignKey("DNXTest.Models.ContactIdentification", "Id");

                    b.HasOne("DNXTest.Models.SpokenLanguage")
                        .WithMany()
            ...
            modelBuilder.Entity("DNXTest.Models.DonorContext", b =>
                {
                    b.HasOne("DNXTest.Models.ContactDonorInfo")
                        .WithMany()
                        .HasForeignKey("ContactDonorInfoId");
                });
            ...
            modelBuilder.Entity("DNXTest.Models.SpokenLanguage", b =>
                {
                    b.HasOne("DNXTest.Models.ContactIdentification")
                        .WithMany()
                        .HasForeignKey("ContactIdentificationId");
                });
